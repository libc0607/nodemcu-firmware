...
ret_t rtl8370_setAsicPortForceLink(uint32 port, rtl8370_port_ability_t *portability)
{
    ...
    os_memset(&ability, 0x00, sizeof(rtl8370_port_ability_t));
    os_memcpy(&ability, portability, sizeof(rtl8370_port_ability_t));    
...
ret_t rtl8370_getAsicPortForceLink(uint32 port, rtl8370_port_ability_t *portability)
{
    ...
    *accessPtr = regData;
    ...
    os_memcpy(portability, &ability, sizeof(rtl8370_port_ability_t));        
...
ret_t rtl8370_getAsicPortStatus(uint32 port, rtl8370_port_status_t *portstatus)
{
    ...
    os_memset(&status, 0x00, sizeof(rtl8370_port_status_t));
    ...
    *accessPtr = regData;
    ...
    os_memcpy(portstatus, &status, sizeof(rtl8370_port_status_t));        
