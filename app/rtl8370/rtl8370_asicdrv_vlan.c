...
ret_t rtl8370_setAsicVlanMemberConfig(uint32 index, rtl8370_vlanconfiguser *ptr_vlancfg)
{
    ...
    os_memset(&smi_vlancfg, 0x00, sizeof(rtl8370_vlanconfigsmi));
...
ret_t rtl8370_setAsicVlan4kEntry(rtl8370_user_vlan4kentry *ptr_vlan4kEntry )
{
    ...
    os_memset(&vlan_4k_entry, 0x00, sizeof(rtl8370_vlan4kentrysmi));
...
#if defined(CONFIG_RTL8370_ASICDRV_TEST)
    os_memcpy(&Rtl8370sVirtualVlanTable[ptr_vlan4kEntry->vid], &vlan_4k_entry, sizeof(rtl8370_vlan4kentrysmi));
#endif
    return RT_ERR_OK;
}
